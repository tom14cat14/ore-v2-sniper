...
pub struct OreConfig {
    ...
    pub deployment_per_cell_sol: f64, // Amount we deploy into each cell (default: 1.0 SOL)
    ...
    pub paper_trading_balance: f64, // Simulated wallet balance for paper trading (default: 1.0 SOL)
...
impl OreConfig {
    ...
    pub fn from_env() -> Result<Self> {
        ...
        Ok(Self {
            ...
            target_cells_per_round: env::var("TARGET_CELLS_PER_ROUND")
                ...
                .parse()?,
            deployment_per_cell_sol: env::var("DEPLOYMENT_PER_CELL_SOL")
            ...
            paper_trading: env::var("PAPER_TRADING").unwrap_or_else(|_| "true".to_string())
                == "true",
            paper_trading_balance: env::var("PAPER_TRADING_BALANCE")
                .unwrap_or_else(|_| "1.0".to_string())
                .parse()?,
    ...
    pub fn validate(&self) -> Result<()> {
        ...
        // Allow negative EV for "cover all cells" strategies
